 ...
 * generated in the jws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _LoginResponse_QNAME = new QName("http://service.jws/", "loginResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://service.jws/", "multiplyResponse");
    private final static QName _Sum_QNAME = new QName("http://service.jws/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://service.jws/", "sumResponse");
    private final static QName _Login_QNAME = new QName("http://service.jws/", "login");
    private final static QName _Multiply_QNAME = new QName("http://service.jws/", "multiply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jws/", name = "loginResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jws/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jws/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jws/", name = "sumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jws/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jws/", name = "multiply")
